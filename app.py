...
# ================= SEMESTER SETUP =========================
    ...
    if st.session_state.subjects.empty:
        ...
        selected = st.selectbox("Select Subject", names, key="subject_select")
...
# ================= STUDY SESSION ==========================
    ...
    if st.session_state.study_running:
        ...
        st.info("⏳ Keep this page open for timer to work. Refresh to continue.")
    else:
        ...
        if st.session_state.subjects.empty:
            ...
            if st.button("▶️ Start Study", type="primary"):
                st.session_state.current_subject = subject                st.session_state.current_topic = topic
...
# ================= QUIZ ===================================
    ...
    if st.session_state.subjects.empty:
        ...
        if not st.session_state.quiz_questions:
            subject = st.selectbox("Subject", subjects_list, key="quiz_subject_select")
    ...
    if sub.empty:
        ...
        if health:
            try:
                ...
                st.info("Error displaying health data.")
